...
const s = StyleSheet.create({
  ...
  accent: { width: 3, height: 32, borderRadius: 2, backgroundColor: Colors.inkSecondary },
  body: { flex: 1, gap: 2 },
  sender: { fontFamily: FontFamily.bodySemiBold, fontSize: 12, color: Colors.inkPrimary },
