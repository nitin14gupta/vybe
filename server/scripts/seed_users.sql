-- ============================================================
-- Gorave Seed Data — 20 Dummy Users for Discover Feed Testing
...
-- Women
('+910000000001','+91','Priya Sharma',  '2000-03-15','Female','Art gallery hopper 🎨 underground techno at night. Late night chai is mandatory ☕️✨','Mumbai',    19.0596, 72.8295,ARRAY['Music','Art','Nightlife','Photography'],   ARRAY['🔥 Gorave Starter','✨ Early Adopter'],  true,'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3'),
('+910000000002','+91','Aisha Khan',    '2002-07-22','Female','Fashion is self-expression 👗 travel is therapy ✈️ making memories every single day',  'Mumbai',    19.1197, 72.8468,ARRAY['Fashion','Travel','Photography','Food'],     ARRAY['🔥 Gorave Starter','🌟 Main Character'],  true,NULL),
...
('+910000000004','+91','Riya Mehta',    '2003-04-30','Female','Foodie 🍕 music lover 🎵 art enthusiast 🎨 always up for the next unexpected adventure','Mumbai',    19.1074, 72.8274,ARRAY['Food','Music','Art','Movies'],               ARRAY['🔥 Gorave Starter','🎵 Music Head'],      true,NULL),
...
('+910000000008','+91','Dia Kapoor',    '2003-02-14','Female','Capturing life one frame at a time 📸 Art is my superpower 🎨 Nightlife is my timezone','Mumbai',    19.0596, 72.8270,ARRAY['Photography','Art','Nightlife','Fashion'],   ARRAY['🔥 Gorave Starter','🌟 Main Character'],  true,NULL),
...
('+910000000013','+91','Rishi Mehta',   '2001-03-19','Male','Gamer 🎮 coder 💻 sports fan ⚽ living that NPC life unironically lol',                   'Pune',      18.5300, 73.8700,ARRAY['Gaming','Tech','Sports','Movies'],           ARRAY['🔥 Gorave Starter','🎯 Goal Getter'],     true,NULL),
...
('+910000000016','+91','Vihaan Patel',  '2002-09-08','Male','Street food explorer 🍕 travel photographer ✈️ 📸 always on the move',                   'Mumbai',    19.1100, 72.8300,ARRAY['Food','Travel','Photography','Sports'],     ARRAY['✈️ Wanderer','🔥 Gorave Starter'],       true,'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3'),
