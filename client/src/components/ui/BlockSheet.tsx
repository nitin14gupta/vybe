...
function BlockSheetCore({ targetName, isBlocked, loading, onBlock, onUnblock, onClose }: Omit<Props, 'visible'>) {
...
export function BlockSheet({ visible, ...rest }: Props) {
  if (!visible) return null
  return <BlockSheetCore {...rest} />
}
