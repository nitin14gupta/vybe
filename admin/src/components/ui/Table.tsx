...
export function TR({ className, ...props }: React.HTMLAttributes<HTMLTableRowElement>) {
  return <tr className={cn('transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-900/60', className)} {...props} />
}
...
export function TD({ className, ...props }: React.TdHTMLAttributes<HTMLTableCellElement>) {
  return <td className={cn('px-4 py-3 text-zinc-700 dark:text-zinc-300', className)} {...props} />
}
