...
const s = StyleSheet.create({
  ...
  skAvatar: { width: 52, height: 52, borderRadius: 26, backgroundColor: Colors.surfaceMuted },
  skInfo: { flex: 1, gap: 8 },
  skLineName: { height: 14, width: '55%', borderRadius: 7, backgroundColor: Colors.surfaceMuted },
  skLineUser: { height: 12, width: '35%', borderRadius: 6, backgroundColor: Colors.surfaceMuted },
})
